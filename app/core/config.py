...
class Settings(BaseSettings):
    ...
    NO_PROXY: str = Field(
        default="localhost,127.0.0.1,eastmoney.com,push2.eastmoney.com,82.push2.eastmoney.com,82.push2delay.eastmoney.com,gtimg.cn,sinaimg.cn,api.tushare.pro,42.194.163.97,baostock.com"
    )
    ...
    TUSHARE_API_URL: str = Field(default="http://api.tushare.pro", description="Tushare Pro API endpoint")
